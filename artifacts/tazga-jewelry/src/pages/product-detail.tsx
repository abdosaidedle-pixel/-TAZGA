  ...
  return (
    <div className="min-h-screen pt-24 pb-20">
      <div className="container mx-auto px-4 md:px-8">
        ...
        {/* Breadcrumbs */}
        <div className="flex items-center gap-2 text-xs text-muted-foreground uppercase tracking-wider mb-8 font-serif">
        ...
        <div className="flex flex-col lg:flex-row gap-12 mb-24">
          ...
          <div className="w-full lg:w-1/2 flex flex-col">
            ...
            <div className="prose prose-invert prose-p:font-light prose-p:leading-relaxed prose-p:text-muted-foreground mb-8">
              <p>{product.description || "A beautiful piece of handcrafted jewelry."}</p>
              <p dir="rtl" className="font-arabic mt-4 text-right">
                {product.descriptionAr || "قطعة جميلة من المجوهرات المصنوعة يدوياً."}
              </p>
            </div>
            ...
            <div className="border-t border-white/10 divide-y divide-white/10">
              <div className="py-4">
                <h3 className="font-serif tracking-wider mb-2 text-sm uppercase">Details</h3>
                <ul className="space-y-2 text-sm text-muted-foreground font-light">
                  {product.material && <li><span className="text-foreground font-serif">Material:</span> {product.material}</li>}
                  <li><span className="text-foreground font-serif">SKU:</span> {product.sku || product.id}</li>
                </ul>
              </div>
              ...
              <div className="py-4 space-y-4 font-serif">
                ...
                <div className="flex items-center gap-3 text-sm text-muted-foreground">
                  ...
                  <span>2-year warranty & certificate of authenticity</span>
                </div>
              </div>
            </div>
          </div>
